...
export const outcomeContent: Record<EligibilityOutcome | Route, OutcomeContent> = {
  ...
  ELIGIBLE: {
    ...
    body: 'Once registered, you’ll be an Irish citizen and can apply for an Irish passport. We’ll build your personalised document checklist based on your specific circumstances.',
    cta: { label: 'Build my document checklist →', kind: 'checklist' },
  },
  ROUTE_A: {
    emoji: '✅',
    headline: "You're eligible for Foreign Birth Registration",
    body: 'Because one of your grandparents was born on the island of Ireland, you can apply to be entered on the Foreign Births Register. Once registered, you’ll be an Irish citizen and can apply for an Irish passport.\n\nThis is the grandparent route (the most common route).',
    cta: { label: 'Build my document checklist →', kind: 'checklist' },
  },
  ROUTE_B_FBR: {
    emoji: '✅',
    headline: "You're eligible for Foreign Birth Registration",
    body: 'Because one of your parents is an Irish citizen — through their own Irish-born parent or their own FBR registration — you can apply to be entered on the Foreign Births Register.',
    note: 'Your parent must have been an Irish citizen before you were born for this to work. If your grandparent was born in Ireland, your parent was a citizen from their own birth — so this timing condition is automatically met.',
    cta: { label: 'Build my document checklist →', kind: 'checklist' },
  },
  ROUTE_B_NATURALISATION: {
    emoji: '✅',
    headline: "You're eligible for Foreign Birth Registration",
    body: 'Because one of your parents became an Irish citizen through naturalisation before you were born, you can apply to be entered on the Foreign Births Register.',
    note: "You'll need your parent's original Irish Naturalisation Certificate as part of your application.",
    cta: { label: 'Build my document checklist →', kind: 'checklist' },
  },
  ROUTE_B_POSTNUPTIAL: {
    emoji: '✅',
    headline: "You're eligible for Foreign Birth Registration",
    body: 'Because one of your parents became an Irish citizen through a Post-Nuptial Citizenship Declaration before you were born, you can apply to be entered on the Foreign Births Register.',
    note: "You'll need your parent's original Post-Nuptial Citizenship Certificate as part of your application.",
    cta: { label: 'Build my document checklist →', kind: 'checklist' },
  },
  ROUTE_B_ADOPTION: {
    emoji: '⚠️',
